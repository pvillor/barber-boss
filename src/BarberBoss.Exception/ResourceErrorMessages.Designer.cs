...
namespace BarberBoss.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Billings cannot be for the future..
        /// </summary>
        public static string BILLINGS_CANNOT_FOR_FUTURE {
            get {
                return ResourceManager.GetString("BILLINGS_CANNOT_FOR_FUTURE", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Billings must be greater than 0..
        /// </summary>
        public static string BILLINGS_GREATER_THAN_ZERO {
            get {
                return ResourceManager.GetString("BILLINGS_GREATER_THAN_ZERO", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Password must contain at least 8 chars, one uppercase, one lowercase, one number and a special char (ex: !, ?, #).
        /// </summary>
